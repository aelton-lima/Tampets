...
<?php while($row = $listaLocais -> fetch_assoc()) {
  echo "<div class='card-wrapper'>
            ...
            <div class='card-bottom'>
                <a href='$row[link_maps]' target='_blank'><img src='https://cdn-icons-png.flaticon.com/512/684/684908.png'
                        alt='Maps' /></a>
                <a href='https://api.whatsapp.com/send?phone=55$row[telefone]' target='_blank'><img
                        src='https://cdn-icons-png.flaticon.com/512/733/733585.png' alt='WhatsApp' /></a>
                <a href='tel:+55$row[telefone]' target='_blank'> <img src='/assets/img/telefone.png' alt='Telefone'></a>
            </div>
        </div>";
      }
?>
